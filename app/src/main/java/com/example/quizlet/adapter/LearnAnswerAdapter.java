...
public class LearnAnswerAdapter extends RecyclerView.Adapter<LearnAnswerAdapter.ViewHolder> {
    public static int count = 0;
    private ArrayList<Answers> getAnswers;
    private Context getContext;
    private ArrayList<Answers> getAnswers1;

    public LearnAnswerAdapter(ArrayList<Answers> getAnswers, Context getContext, ArrayList<Answers> getAnswers1) {
...
//
                if (markColor[0] == 0) {
                    ...
                    markColor[0] = 1;
                    if(getAnswers.get(position).isTrue()){
                        holder.tvAnswer.setBackgroundColor(Color.GREEN);
                    }
